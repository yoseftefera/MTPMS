...
|--------------------------------------------------------------------------
|
| Configuration for tymon/jwt-auth package.
...
return [
    ...
    */
    ...
    |
    | Set to null for infinite refresh time.
    | Note: If using a blacklist this is the time that the token will remain
    | in the blacklist.
    |
    */
    ...
    | and here: https://github.com/namshi/jose/tree/master/src/Namshi/JOSE/Signer/SecretKey
    | for possible values.
    |
    */
    ...
    */
    ...
    | it is possible that some of those requests fail, due to token
